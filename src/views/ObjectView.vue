...
<template>
    <main class="flex mt-10 px-8">
        <div class="m-auto max-w-lg md:max-w-2xl xl:max-w-2xl ">
            <h2 class="scroll-m-20 text-3xl mb-1 font-semibold tracking-tight transition-colors first:mt-0">
            ...
            <img src="https://telescopius.com/img/dsos/6ad5dfee4eda09255d9a7bd929b23df9_fullhd.webp" alt="Orion nebula"
