  ...
  <FilterTemplate>
    ...
    <div class="mt-2 flex items-center space-x-2">
      ...
      <NumberField
        @update:model-value="
          (v) => {
            v ? (filters.altitude.value = v) : (filters.altitude.value = 0)
          }
        "
        :default-value="filters.altitude.value"
        :min="0"
        :max="90"
        :step="5"
      >
    ...
    <div class="mt-2 flex items-center space-x-2">
      ...
      <NumberField
        @update:model-value="
          (v) => {
            v ? (filters.altitude.time = v) : (filters.altitude.time = 0)
          }
        "
        :default-value="filters.altitude.time"
        :min="0"
        :max="900"
        :step="5"
      >
    ...
    <div class="mt-3">
      <SearchSelectFilter
        ...
        notFoundTitle="Aucune constellation trouvée."
  ...
  <div class="w-[18.5rem] w-max-[18.5rem] flex-shrink-0 px-8" v-show="showFilterSideNav">
    ...
    <p class="mt-4 font-semibold flex items-center space-x-2">
      ...
      <span class="overflow-ellipsis overflow-hidden w-[14rem] text-nowrap"
        ...
        }}{{ session.location.countryName ? ", " : "" }}{{ session.location.countryName }}</span
      >
    </p>
