...
<template>
    <main class="flex mt-10">
        ...
        <div class="w-full px-8">
            ...
            <p class="font-semibold w-full overflow-ellipsis overflow-hidden text-nowrap mb-4"
            ...
            <Button variant="outline" class="mb-4 inline-flex items-center" v-show="isMobile || showFilterNavButton"
                @click="isFilterOpen = !isFilterOpen">
                <Filter class="h-4 mr-2" />Afficher les filtres
            </Button>

            <ResultCard title="Les Pleiades" descriptors="Lever : 18h22 - Coucher : 2h15"
